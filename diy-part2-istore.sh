...
sed -i 's#https://github.com/breakings/OpenWrt#https://github.com/sxrcuo/Actions-OpenWrt-N1#g' package/luci-app-amlogic/luci-app-amlogic/root/etc/config/amlogic
